...
class BsTree:
    ...
    def fit(self, dataSet, labelset, sampIndex, labelIndex):  # 通过读入数据集开始训练/构造一棵决策树,样本的索引，签值的索引
        ...
        self._root = self.__ConstructDecisionTreeCycle(self.raw_dataset, self.raw_labelset,self.raw_samp_row, self.raw_label_dict)
